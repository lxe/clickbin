...
# code originally from: http://code.google.com/p/marlon-tools/source/browse/tools/dnsproxy/dnsproxy.py
# start up the server using the instructins bellow. make sure to set 127.0.0.1 
# as you DNS under System Preferences -> Network -> Advanced -> DNS
# - Vicapow
